...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		{
			JOptionPane.showMessageDialog(null, "You are incorrect " + person);
		}
		...
		{
			JOptionPane.showMessageDialog(null, "You are incorrect " + person2);
		}
		
		showNextImage();
		
		
		String person3 = "Leonardo";
		
String guess3 = JOptionPane.showInputDialog("who is this?");
		
		if(guess3.equals(person3))
		{
			JOptionPane.showMessageDialog(null,"You are correct");
		...
		{
			JOptionPane.showMessageDialog(null, "You are incorrect " + person3);
		}
		
		showNextImage();
		
		
		String person4 = "Morgan";
		
String guess4 = JOptionPane.showInputDialog("who is this?");
		
		if(guess4.equals(person4))
		{
			JOptionPane.showMessageDialog(null,"You are correct");
		...
		{
			JOptionPane.showMessageDialog(null, "You are incorrect " + person4);
		}
