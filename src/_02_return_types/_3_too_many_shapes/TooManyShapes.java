...
String shapes = JOptionPane.showInputDialog("How many shapes do you want your shape to have");
	...
	int shape = Integer.parseInt(shapes);
		...
		int angle = calculateTurnAngle(side);
